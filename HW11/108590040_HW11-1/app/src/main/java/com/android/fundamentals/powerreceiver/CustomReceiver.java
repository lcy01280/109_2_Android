...
public class CustomReceiver extends BroadcastReceiver {
    ...
    private static final String RANDOM_NUMBER = "com.android.fundamentals.powerreceiver.RANDOM_NUMBER";
    /**
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intentAction != null) {
            ...
            Toast.makeText(context, toastMessage + " Square of the Random number is " + number * number, Toast.LENGTH_SHORT).show();
        }
    }
}
